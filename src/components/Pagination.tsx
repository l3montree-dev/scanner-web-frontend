    ...
    <div>
      {props.page > 2 && (
        <button
          ...
          className={classNames(
            "page-box px-3 py-1 mx-1 mr-5 border border-deepblue-50 transition-all hover:bg-deepblue-500"
          )}
        >
          1
        </button>
      ...
      {pages.map((i) => {
        return (
          <button
            ...
            className={classNames(
              "page-box px-3 py-1 mx-1 border border-deepblue-50 transition-all hover:bg-deepblue-500",
      ...
      {props.page + 2 < lastPage && (
        <button
          ...
          className={classNames(
            "ml-5 page-box px-3 py-1 mx-1 border border-deepblue-50 transition-all hover:bg-deepblue-500"
          )}
        >
