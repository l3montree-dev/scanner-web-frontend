    ...
    <div>
      {props.page > 2 && (
        <button
          ...
          className={classNames(
            "page-box px-3 py-1 mx-1 mr-5 border border-hellgrau-100 transition-all hover:bg-dunkelblau-100 hover:text-white"
          )}
        >
          1
        </button>
      ...
      {pages.map((i) => {
        return (
          <button
            ...
            className={classNames(
              "page-box px-3 py-1 mx-1 border border-hellgrau-100 transition-all hover:bg-dunkelblau-100 hover:text-white",
              i === props.page && "bg-dunkelblau-100 text-white"
            )}
            key={i}
          >
            {i + 1}
      ...
      {props.page + 2 < lastPage && (
        <button
          ...
          className={classNames(
            "ml-5 page-box px-3 py-1 mx-1 border border-hellgrau-100 transition-all hover:bg-dunkelblau-100 hover:text-white"
          )}
        >
