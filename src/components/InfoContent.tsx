        ...
        <div className="mx-20">
          ...
          <div className="mt-10">
            <p>
              ...
              IT-Sicherheit in der öffentlichen Verwaltung weiter vorantreiben
              und hat in Zusammenarbeit mit dem Bundesamt für Sicherheit in der
            ...
            <p>
              ...
              unterstützt und begleitet werden. Die Challenge gilt dann von den
              Personen als erfolgreich umgesetzt, wenn alle sechs
            ...
            <ul>
              ...
              <li>
                ...
                stellt ein Sicherheitsprotokoll zur Verschlüsselung von Daten
                für eine sichere Datenübertragung im Internet dar.
              </li>
              <li>
              ...
              <li>
                ...
                falsche Server gelangen. Dies geschieht durch die Zuordnung von
            ...
            <p>
              ...
              OZG-Security-Challenge demonstrieren: Der weiße Sticker
            ...
            <p>
              ...
              sechs spezifischen IT-Sicherheitsmaßnahmen dargestellt. Diese
              wurden ausgewählt, da sie den gültigen IT-Sicherheitsstandards der
              öffentlichen Verwaltung entsprechen und einen wichtigen Beitrag
            ...
            <p>
              ...
              weitere Kriterien zu erweitern. Der Schnelltest wird daher auch
              nach der Challenge weiterhin zur Verfügung stehen.
            </p>
            <h2>
            ...
            <p>
              ...
              Digitale Innovation und Infrastruktur des Koalitionsvertrags, die
              Möglichkeit echter verschlüsselter Kommunikation anzubieten. Zudem
              werden alle staatlichen Stellen verpflichtet, ihnen bekannte
              Sicherheitslücken beim BSI zu melden und sich regelmäßig einer
              externen Überprüfung ihrer IT-Systeme zu unterziehen.
            </p>
            <p>
            ...
            <p>
              ...
              klar, dass die Verwaltungsdigitalisierung nur erfolgreich sein
              kann, wenn sie eine wirkliche Verbesserung für Alle mit sich
              bringt und die konzipierten Onlinedienste auch akzeptiert und
              genutzt werden. Daher gilt es, das Vertrauen der Bürgerinnen,
              Bürger und Unternehmen in die Onlinedienste zu stärken.
            </p>
            <p>
              Die OZG-Security-Challenge setzt hier an und regt zur Steigerung
              der Bekanntheit der IT-Sicherheitsmaßnahmen an und unterstützt die
              OZG-Dienstverantwortlichen durch ein umfassendes Sprechstunden-
              und Kommunikationsangebot bei deren Umsetzung.
            </p>
          </div>
        </div>
      </div>
