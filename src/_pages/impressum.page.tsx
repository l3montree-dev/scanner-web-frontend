      ...
      <div className="flex-1">
        <Article title="Impressum" teaser="">
          <p>
            ...
            Ministeriums erleichtern und ein zutreffendes Bild von den
            Tätigkeiten, Planungen und Vorhaben des Bundesministeriums des
            Innern und für Heimat vermitteln. Auf die Richtigkeit, Aktualität,
            Vollständigkeit, Verständlichkeit und jederzeitige Verfügbarkeit der
            bereitgestellten Informationen wird sorgfältig geachtet.
            <br />
            <br />
            ...
            das Bundesministerium des Innern und für Heimat (Redaktion) nach
            bestem Wissen und unter Beachtung größtmöglicher Sorgfalt erstellt
            und vermitteln lediglich den Zugang zu &quot;fremden Inhalten&quot;.
            Dabei wurde auf die Vertrauenswürdigkeit dritter Anbieter und die
            Fehlerfreiheit sowie Rechtmäßigkeit der &quot;fremden Inhalte&quot;
            besonders geachtet.
            <br />
            Da jedoch der Inhalt von Internetseiten dynamisch ist und sich
            jederzeit ändern kann, ist eine stetige Einzelfallprüfung sämtlicher
            Inhalte, auf die ein Link erstellt wurde, nicht in jedem Fall
            möglich. Das Bundesinnenministerium macht sich deshalb den Inhalt
            von Internet-Seiten Dritter, die mit der eigenen Internetpräsenz
            verlinkt sind, insoweit ausdrücklich nicht zu eigen. Für
            <br />
            Schäden aus der Nutzung oder Nichtnutzung &quot;fremder
            Inhalte&quot; haftet ausschließlich der jeweilige Anbieter der
            Seite, auf die verwiesen wurde.
            <br />
            <br />
            2. Eigene Inhalte
            <br />
            <br />
            Soweit die auf diesen Seiten eingestellten Inhalte
            Rechtsvorschriften, amtliche Hinweise, Empfehlungen oder Auskünfte
            enthalten, sind sie nach bestem Wissen und unter Beachtung
            größtmöglicher Sorgfalt erstellt. Bei Unstimmigkeiten gilt jedoch
            ausschließlich die aktuelle amtliche Fassung, wie sie im dafür
            vorgesehenen amtlichen Verkündungsorgan veröffentlicht ist. Etwaige
            rechtliche Hinweise, Empfehlungen und Auskünfte sind unverbindlich;
            ...
            Herunterladen von Daten durch Computerviren oder der Installation
            ...
            rechtswidrige oder fehlerhafte Inhalte Dritter verweisen, so bittet
            die Redaktion die Nutzer von www.bmi.bund.de (hier ozgsec.de) darum,
            hierauf ggf. aufmerksam zu machen. Ebenso wird um eine Nachricht
            über das{" "}
            <a
            ...
            gebeten, wenn eigene Inhalte nicht fehlerfrei, aktuell, vollständig
            ...
            <br />
            Das Copyright für Bilder liegt, soweit nicht anders vermerkt, bei
            der Bundesrepublik Deutschland, vertreten durch das
            Bundesministerium des Innern und für Heimat oder durch die
            Bundesbildstelle des Presse- und Informationsamtes der
            Bundesregierung.
            <br />
            Auf den BMI-Webseiten zur Verfügung gestellte Texte, Textteile,
            Grafiken, Tabellen oder Bildmaterialien dürfen ohne vorherige
            Zustimmung des BMI nicht vervielfältigt, nicht verbreitet und nicht
            ausgestellt werden.
            <br />
            <br />
          ...
          <ol>
            <li>
              ...
              Urhebern der digitalen Bilder erworben, soweit nichts
              Gegenteiliges, z.B. in den begleitenden Bildinformationen,
              angegeben ist.
            </li>
            <li>
              Die Bildinformationen und die darin enthaltenen Nutzungs- und
              Verwendungsbeschränkungen sind zu beachten. Für die aus der
              Nichtbeachtung resultierenden Schäden haftet der Nutzer. Er hat
              das BMI insoweit von Ansprüchen Dritter freizustellen.
            </li>
            <li>
              Mit dem Quellennachweis &quot;BMI&quot; ausgezeichnete Bilder
              können grundsätzlich kostenfrei heruntergeladen und im Rahmen der
            ...
            <li>
              ...
              Grundsätze des Deutschen Presserates (Pressekodex) verpflichtet.
              Die Zustimmung zur Nutzung des Bildmaterials umfasst nicht die
              Zusicherung, dass die abgebildeten Personen, die Inhaber der
              Rechte an abgebildeten Werken oder die Inhaber von Marken- und
              sonstigen Schutzrechten die Einwilligung zu einer öffentlichen
              Wiedergabe erteilt haben. Die Einholung der im Einzelfall
              notwendigen Einwilligunge Dritter obliegt dem Nutzer. Er hat die
            ...
            <li>
              Das BMI behält sich vor, dem Verdacht einer missbräuchlichen
              Nutzung oder einer wesentlichen Nutzungsverletzung nachzugehen.
            </li>
            <li>
              Bei Verwendung des digitalen Bildes ist die Quelle
              &quot;Bundesministerium des Innern und für Heimat&quot; anzugeben.
              Dies gilt auch für elektronische Publikationen (z.B. Webseiten).
              Von jeder Veröffentlichung im Druck ist dem BMI ein Belegexemplar
